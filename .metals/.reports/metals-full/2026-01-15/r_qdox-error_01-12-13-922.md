error id: file://<WORKSPACE>/src/main/java/VaLocaProject/Services/JWTService.java
file://<WORKSPACE>/src/main/java/VaLocaProject/Services/JWTService.java
...
```java
offset: 122
uri: file://<WORKSPACE>/src/main/java/VaLocaProject/Services/JWTService.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/src/main/java/VaLocaProject/Services/JWTService.java