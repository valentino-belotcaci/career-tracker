...
### com.thoughtworks.qdox.parser.ParseException: syntax error @[11,67]
...
public interface UserRepository extends JpaRepository<User, Long> {
        @Query("SELECT * from users WHERE account_id = :accountId",@@ nativeQuery=true)
...
QDox parse error in file://<WORKSPACE>/src/main/java/VaLocaProject/Repositories/UserRepository.java