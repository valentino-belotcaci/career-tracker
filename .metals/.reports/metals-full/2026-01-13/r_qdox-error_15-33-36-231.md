error id: file://<WORKSPACE>/src/main/java/VaLocaProject/SecurityConfig.java.java
file://<WORKSPACE>/src/main/java/VaLocaProject/SecurityConfig.java.java
...
```java
offset: 22
uri: file://<WORKSPACE>/src/main/java/VaLocaProject/SecurityConfig.java.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/src/main/java/VaLocaProject/SecurityConfig.java.java