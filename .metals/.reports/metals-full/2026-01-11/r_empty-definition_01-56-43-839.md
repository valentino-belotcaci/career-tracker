error id: file://<WORKSPACE>/src/main/java/VaLocaProject/Services/AccountService.java:_empty_/Account#getAccountId#
file://<WORKSPACE>/src/main/java/VaLocaProject/Services/AccountService.java
empty definition using pc, found symbol in pc: _empty_/Account#getAccountId#
...
public class AccountService {
    ...
    public Account insertAccount(Account account){
       account.g@@etAccountId() = null; // set as null the id to be set then by DB
