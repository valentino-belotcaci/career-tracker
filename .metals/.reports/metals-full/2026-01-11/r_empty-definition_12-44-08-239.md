error id: file://<WORKSPACE>/src/main/java/VaLocaProject/Services/JobPostService.java:_empty_/JobPost#setCreatedAt#
file://<WORKSPACE>/src/main/java/VaLocaProject/Services/JobPostService.java
empty definition using pc, found symbol in pc: _empty_/JobPost#setCreatedAt#
...
public class JobPostService {
    ...
    public JobPost insertPost(JobPost jobPost){
        ...
        jobPost.setCreated@@At(new java.sql.Date(System.currentTimeMillis()));
