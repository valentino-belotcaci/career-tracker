error id: file://<WORKSPACE>/src/main/java/VaLocaProject/Repositories/JobPostRepository.java
file://<WORKSPACE>/src/main/java/VaLocaProject/Repositories/JobPostRepository.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[13,84]

error in qdox parser
file content:
```java
offset: 490
uri: file://<WORKSPACE>/src/main/java/VaLocaProject/Repositories/JobPostRepository.java
text:
```scala
...
public interface JobPostRepository extends JpaRepository<JobPost, Long> {
    @NativeQuery(value = "SELECT * FROM job_posts WHERE company_id = :companyId",  =@@ true)
...
QDox parse error in file://<WORKSPACE>/src/main/java/VaLocaProject/Repositories/JobPostRepository.java